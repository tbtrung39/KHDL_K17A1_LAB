'''6. Nhập một chuỗi Str từ bàn phím, kiểm tra chuỗi Str có phải là chuỗi được viết trong hệ 
Hex (0,1....,9, A, B,C,D,E,F) hay không. Nếu không phải thì loại bỏ các ký tự không thuộc 
hệ Hex và chuyển chuỗi còn lại sang số thập phân.'''
