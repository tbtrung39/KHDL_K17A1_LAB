with open("lab11/bai9/PASSENGER.IN", mode="r", encoding="utf-8") as file_pass:
...
with open("lab11/bai9/WEIGHT.OUT", mode="w") as file_weight:
    file_weight.writelines(list_number_total_chain)

with open("lab11/bai9/CANCELED.OUT", mode="w") as file_canceled:
