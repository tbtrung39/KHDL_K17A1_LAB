with open(file =r"lab11\bai9\PASENGER.IN", mode="r") as file_pass:
...
with open(file=r"lab11\bai9\WEIGHT.IN", mode="w") as file_weight:
    file_weight.writelines(list_number_total_chain)

with open(file = r"lab11\bai9\CANCELED.OUT", mode="w") as file_canceled:
