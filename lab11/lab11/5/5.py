...
sbd_ph_path = '5/Sbd_Ph.dat'
sbd_ten_path = '5/SBD_Ten.txt'
phieu_diem_path = '5/Phieu_Diem.txt'
ketqua_path = '5/Ketqua.txt'

# Bước 1: Đọc dữ liệu từ các tệp
sbd_ph_data = {}
sbd_ten_data = {}
phieu_diem_data = {}
...
try:
    ...
    # Bước 2: Ghép dữ liệu từ các tệp và sắp xếp theo điểm giảm dần
    result = []
    ...
    # Bước 3: Ghi kết quả ra tệp Ketqua.txt
