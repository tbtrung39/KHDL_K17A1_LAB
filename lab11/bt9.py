with open('lab11/PASSENGERS.IN','r') as file_pass:
...
print("STT khách có số lượng đồ vượt quá 5:", list_quantity)
list_stt_quantity = []
...
with open('lab11/WEIGHT.OUT','w') as file_weight:
    file_weight.writelines(list_number_total_chain)

with open('lab11/CANCELED.OUT','w') as file_canceled:
