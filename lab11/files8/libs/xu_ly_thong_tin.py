...
def nhapthongtinnv():
    ...
    while i <=soluongnv:
        ...
        i+=1
    with open("lab11/files8/files/ds_nhanvien.csv","w",newline='') as file_nhanvien:
...
def inthongtin():
    with open("lab11/files8/files/ds_nhanvien.csv","r") as file_read:
        ...
        for row in list_thong_tin:
            ...
            print()
def sapxepthongtin():
    with open("lab11/files8/files/ds_nhanvien.csv","r") as file_thong_tin:
